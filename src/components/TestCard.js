...
const TestimonialCard = ({ imageSrc, name, role, rating, testimonial }) => {
  ...
  return (
    <div className="relative flex-col bg-white shadow-md max-w-lg my-8 py-6 w-[120vh]  px-4 h-[55vh] flex items-center">
      <div className="mt-10">
        <div className="absolute -left-10 mt-10  transform -translate-y-1/2">
          <Image
            src={imageSrc}
            alt={name}
            width={100}
