...
const BlogPageCard = (params) => {
  return (
    <div className="card w-full mb-4 rounded-none  bg-base-100 shadow-xl">
      <figure>
        <a href="/SingleBlog">
          <img
            src={`${params.i}.jpg`}
      ...
      <div className="card-body p-4">
        ...
        <a href="/SingleBlog">
          <h2 className="card-title hover:text-orange-500 ease-in-out duration-500 ">
