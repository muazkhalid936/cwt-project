...
<div className="flex justify-center">
        ...
        <div className="h-[70vh] lg:h-[100vh] border asd hover:-translate-y-5 group ease-in-out overflow-hidden group duration-500 w-[50vh] ">
        <div className=" ss h-[40vh] w-[54vh] -ml-3 bg-orange-100 ease-in-out duration-500  -mt-44 lg:-mt-24 group-hover:bg-orange-500 overflow-hidden  rounded-full z-10 group"></div>
      ...
      <div className=" h-[70vh] lg:h-[100vh] border asd hover:-translate-y-5 ease-in-out duration-500 w-[50vh] overflow-hidden">
        <div className=" bg-orange-500 h-[40vh] w-[54vh] -ml-3  -mt-44 lg:-mt-24 rounded-full z-10 group"></div>
        <div className="flex flex-col z-20 -mt-28 ">
      ...
      <div className="h-[70vh] lg:h-[100vh] border asd hover:-translate-y-5 ease-in-out group duration-500 w-[50vh] overflow-hidden">
        <div className=" ss h-[40vh] w-[54vh] -ml-3 -mt-44 lg:-mt-24 rounded-full bg-orange-100 group-hover:bg-orange-500 ease-in-out duration-500  z-10 group"></div>
        <div className="flex flex-col z-20 -mt-28">
